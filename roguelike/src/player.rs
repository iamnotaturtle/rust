...
pub fn player_input(gs: &mut State, ctx: &mut Rltk) -> RunState {
    ...
    match ctx.key {
        ...
        Some(key) => match key {
            ...
            // Diagonals
            VirtualKeyCode::E | VirtualKeyCode::U => try_move_player(1, -1, &mut gs.ecs),

            VirtualKeyCode::Q | VirtualKeyCode::Y => try_move_player(-1, -1, &mut gs.ecs),

            VirtualKeyCode::X | VirtualKeyCode::N => try_move_player(1, 1, &mut gs.ecs),

            VirtualKeyCode::Z | VirtualKeyCode::B => try_move_player(-1, 1, &mut gs.ecs),
